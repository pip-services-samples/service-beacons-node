...
const version1_1 = require("../../../src/services/version1");
...
suite('BeaconsHttpClientV1', () => {
    ...
    let fixture;
    setup((done) => {
        persistence = new persistence_1.BeaconsMemoryPersistence();
        persistence.configure(new pip_services3_commons_node_1.ConfigParams());
        controller = new logic_1.BeaconsController();
        ...
        service = new version1_1.BeaconsHttpServiceV1();
